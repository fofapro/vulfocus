<template>
  <div class="login-container">
    ...
    <div class="form-container" align="center">
      <el-form :model="ruleForm"  class="login-form" :inline="true" status-icon :rules="rules" ref="ruleForm" auto-complete="on" label-position="left" >
        ...
        <div style="padding-top: 10px;margin-left: 225px">
          <el-button type="primary" @click="handleConfirm">更新密码</el-button>
        </div>
      </el-form>
    </div>
  </div>
